...
export default function Home() {
	return (
		<>
			...
			<section class="  bg-[url('https://www.novaurology.com/wp-content/uploads/2021/04/MYP_Summit-PR-3091-optimized.jpg')] bg-cover bg-gray-700 bg-blend-hard-light bg-fixed dark:bg-blend-multiply">
				<div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
					...
					<p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">Here at Merrit Hospital we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
			...
			<section class="bg-gray-50 dark:bg-gray-900">
				<div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
					<div class="flex flex-col justify-center">
						...
						<p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Here at Merrit Hospital we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
